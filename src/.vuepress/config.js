module.exports = {
  ...
  locales: {
    ...
    '/es/': {
      lang: 'es',
      title: 'Manual de testing en Vue',
    },
  },
  themeConfig: {
    ...
    locales: {
      ...
      '/es/': {
        ...
        sidebar: [
          ['/es/', 'Bienvenido'],
          ['/es/setting-up-for-tdd', 'Preparándote para TDD'],
          ['/es/rendering-a-component', 'Renderizado de componentes'],
          ['/es/components-with-props', 'Pruebas de props'],
          ['/es/computed-properties', 'Computed Properties'],
          ['/es/simulating-user-input', 'Simulación de entrada de usuario'],
          ['/es/testing-emitted-events', 'Pruebas de eventos emitidos'],
          ['/es/mocking-global-objects', 'Mocking de objetos globales'],
          ['/es/stubbing-components', 'Stubbing de componentes'],
          [
            '/es/finding-elements-and-components',
            'Encontrar elementos y componentes',
          ],
          ['/es/testing-vuex', 'Pruebas de Vuex'],
          ['/es/vuex-mutations', 'Vuex - Mutaciones'],
          ['/es/vuex-actions', 'Vuex - Acciones'],
          ['/es/vuex-getters', 'Vuex - Getters'],
          ...
          ['/es/composition-api', 'Composition API'],
          ['/es/reducing-boilerplate-in-tests', 'Reducir el boilerplate'],
          ['/es/jest-mocking-modules', 'Jest - mocking de módulos'],
        ],
      },
    },
  },
