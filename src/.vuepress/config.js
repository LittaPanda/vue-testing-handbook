module.exports = {
    ...
    locales: {
        '/': {
            lang: 'en-US',
            title: 'Vue Testing Handbook',
            vue3AnnouncementFirst: 'Hi! Please check out my',
            vue3AnnouncementLink1: 'upcoming',
            vue3AnnouncementLink2: 'course',
            vue3AnnouncementLink3: 'on',
            vue3AnnouncementLink4: 'Vue.js 3',
            vue3AnnouncementLast: ', including the Composition API, TypeScript, and Unit Testing.',
        },
        '/ja/': {
            lang: 'ja-JP',
            title: 'Vueテストハンドブック',
        ...
        '/es/': {
            ...
            vue3AnnouncementFirst: '¡Hola! Por favor mira mi',
            vue3AnnouncementLink1: 'próximo',
            vue3AnnouncementLink2: 'curso',
            vue3AnnouncementLink3: 'en',
            vue3AnnouncementLink4: 'Vue.js 3',
            vue3AnnouncementLast: ', incluye la API de composición, TypeScript y pruebas unitarias.',
        },
    },
    themeConfig: {
        ...
        locales: {
            ...
            '/es/': {
                ...
                sidebar: [
                    ['/es/', 'Bienvenido'],
                    ['/es/setting-up-for-tdd', 'Configuración para TDD (Desarrollo guiado por pruebas)'],
                    ['/es/rendering-a-component', 'Componentes de renderizado'],
                    ['/es/components-with-props', 'Props de prueba'],
                    ['/es/computed-properties', 'Propiedades Computadas'],
                    ['/es/simulating-user-input', 'Simulando entradas de usuario'],
                    ['/es/testing-emitted-events', 'Probando eventos emitidos'],
                    ['/es/mocking-global-objects', 'Simulando (Mocking) objetos globales'],
                    ['/es/stubbing-components', 'Troquelado de componentes'],
                    [
                        '/es/finding-elements-and-components',
                        'Localizar elementos y componentes',
                    ],
                    ['/es/testing-vuex', 'Probando Vuex'],
                    ['/es/vuex-mutations', 'Vuex - Mutations (Mutaciones)'],
                    ['/es/vuex-actions', 'Vuex - Actions (Acciones)'],
                    ['/es/vuex-getters', 'Vuex - Getters (Captadores)'],
                    ['/es/vuex-in-components', 'Vuex en componentes - $state y getters'],
                    [
                        '/es/vuex-in-components-mutations-and-actions',
                        'Vuex en componentes - mutaciones y acciones',
                    ],
                    ['/es/vue-router', 'Vue Router'],
                    ['/es/composition-api', 'Composition API (API de composición)'],
                    ['/es/reducing-boilerplate-in-tests', 'Simplificando plantillas'],
                    ['/es/jest-mocking-modules', 'Jest - modulos para simulación (mocking)'],
                ],
            },
        },
    },
